...
namespace FileIO_Demo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //try
            //{
            //    myBook = new FileStream("joseph.txt", FileMode.Create, FileAccess.Write);
            //    wr = new StreamWriter(myBook);
            //    wr.WriteLine("Hello");
            //    wr.WriteLine("My Name is Joseph DeLorenzo");
            //    wr.WriteLine("I am a Programmer");
            //    wr.WriteLine("I am a From Houston Texas");
            //    wr.WriteLine("I am a working on Microsoft .Net");
            //    wr.WriteLine("I am a from The United States");
            //    wr.WriteLine("I am a also a Therapist");
            //}
            ...
            //try
            //{
            //    myFile = new FileStream("joseph.txt", FileMode.Open, FileAccess.Read);
